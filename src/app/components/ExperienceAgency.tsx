      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="space-y-8">
          {resumeData.experience.map((exp, index) => (
            ...
            >
              ...
              >
                {/* Main Card */}
                <div className="relative bg-gradient-to-br from-white/[0.07] to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden group-hover:border-white/30 transition-all duration-500">
                  {/* Gradient Overlay */}
                  <motion.div
                  ...
                  <div className="relative z-10 p-8 lg:p-12">
                    <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                      ...
                      <div className="lg:col-span-3 space-y-6">
                        ...
                        >
                          <span className="text-[120px] md:text-[160px] font-bold leading-none bg-gradient-to-br from-white/10 to-white/[0.02] bg-clip-text text-transparent select-none">
                            {String(index + 1).padStart(2, '0')}
                          </span>
                          {/* Glowing Accent */}
                          <motion.div
                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-full blur-2xl"
                            animate={{
                        ...
                        >
                          <div className="px-6 py-3 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-400/30 rounded-full backdrop-blur-sm">
                            <div className="flex items-center gap-3">
                              <div className="w-2 h-2 rounded-full bg-blue-400 animate-pulse" />
                              <span className="text-sm text-blue-300 font-medium uppercase tracking-wider">
                                {exp.period}
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="lg:col-span-3 flex flex-col items-start lg:items-end justify-between h-full">
                        {/* Arrow Button */}
                        <motion.div
                          className="w-16 h-16 lg:w-20 lg:h-20 rounded-2xl border-2 border-white/20 backdrop-blur-sm flex items-center justify-center group-hover:border-white group-hover:bg-white transition-all duration-300"
                          whileHover={{ rotate: 45, scale: 1.1 }}
                          transition={{ duration: 0.3 }}
                        >
                          <svg
                            className="w-7 h-7 lg:w-8 lg:h-8 text-white group-hover:text-black transition-colors"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            strokeWidth="2"
                  ...
                  {/* Corner Orb */}
                  <motion.div
                    className="absolute -bottom-12 -right-12 w-40 h-40 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 blur-3xl"
                    animate={{
              ...
              {index < resumeData.experience.length - 1 && (
                <motion.div
                  className="ml-8 lg:ml-24 mt-8 mb-8 h-16 w-px bg-gradient-to-b from-white/20 to-transparent"
        ...
        >
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="text-center md:text-left">
              <motion.p
                className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-3"
                initial={{ opacity: 0, scale: 0.5 }}
                animate={isInView ? { opacity: 1, scale: 1 } : {}}
